namespace ChessGame
{
    partial class frmDashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlEmojiPicker.Location = new Point(15, 320);
            pnlEmojiPicker.Name = "pnlEmojiPicker";
            pnlEmojiPicker.Size = new Size(250, 110);
        ...
        private void AddEmojiToPanel()
        {
            ...
            for (int i = 0; i < emojis.Length; i++)
            {
                ...
                btnEmojiItem.BackColor = Color.White;
                btnEmojiItem.FlatStyle = FlatStyle.Flat;
                btnEmojiItem.FlatAppearance.BorderSize = 0;
                btnEmojiItem.Font = new Font("Segoe UI", 14F, FontStyle.Regular, GraphicsUnit.Point);
                btnEmojiItem.Size = new Size(btnSize, btnSize);
                btnEmojiItem.Location = new Point(x + (i % columns) * (btnSize + spacing),
